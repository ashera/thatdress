...
export async function dispatchVerificationEmail(
  ...
  try {
    ...
    await sendEmail({
      to: email,
      subject: "Verify your frockd email",
      html: emailLayout({
        preheader: "Confirm your email to finish setup.",
        heading: "Verify your email",
        body: `
          <p>Welcome to frockd. Click the button below to confirm <strong>${escapeHtml(email)}</strong> belongs to you. The link expires in 24 hours.</p>
          ...
          <p style="font-size:13px;color:#7a7470;">If you didn't sign up for frockd, you can ignore this message.</p>
        `,
      }),
      text: `Verify your frockd email by visiting: ${url}\n\nThe link expires in 24 hours.`,
    });
  } catch (e) {
